...
import com.markedline.textworker.entity.text.comparator.AscendingLetterAmountOrderComparator;
...
public class Task9 implements TaskService {
    @Override
    public AbstractResult solve(AbstractInputData inputData) {
        ...
        words.sort(new AscendingLetterAmountOrderComparator(givenLetter));
